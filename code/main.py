...
def runGames(player: Agent, rivals: List[Agent], numGames: int,consumerNameList:List, record: bool, numTraining=0):
...
def run_test(playerAgent, sellerAgent, belief, depth, scoreFunction,sellerNum,consumerNum):
    ...
    if sellerAgent == RandomSeller:
        ...
        player = ExpectimaxAgent(belief, scoreFunction, depth)
